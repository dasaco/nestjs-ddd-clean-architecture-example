import { ArgumentNotProvidedException } from 'shared/domain/exceptions';
...
export abstract class ValueObject<T> {
  ...
  // This is a function for value objects that contain value parameter
  // but they are not domain primitives
  public unpackContainingValueParam(): T {
    const propsCopy = convertPropsToObject(this.props);
    return Object.freeze(propsCopy);
  }
